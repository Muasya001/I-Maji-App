...
fun SuccessScreen(navController: NavController, report: PowerOutageReport) {
    val location = remember { navController.currentBackStackEntry?.arguments?.getString("location") }
    val description = remember { navController.currentBackStackEntry?.arguments?.getString("description") }
